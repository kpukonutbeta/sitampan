"""
Django settings for sitampan project.
...
SECRET_KEY = 'django-insecure-)&fwz(p28x4+&*-&_j-_l85_edvk59n6c_peh@4fq%sd$0p^az'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'documents.context_processors.local_ip',
                'documents.context_processors.site_settings',
            ],
        },
    },
]

WSGI_APPLICATION = 'sitampan.wsgi.application'
...
ALLOWED_GOOGLE_EMAILS = [
    'muhakbaryasin.kpukonut@gmail.com',
    'teknisprovsultra@gmail.com'
]